...
ALTER TABLE `Materials` ADD `ImageThumbnailUrl1` longtext NULL;

ALTER TABLE `Materials` ADD `ImageThumbnailUrl2` longtext NULL;

ALTER TABLE `Materials` ADD `ImageThumbnailUrl3` longtext NULL;

ALTER TABLE `Materials` ADD `ImageThumbnailUrl4` longtext NULL;

INSERT INTO `__EFMigrationsHistory` (`MigrationId`, `ProductVersion`)
VALUES ('20191126092519_addedThumbnailToMaterials', '2.1.14-servicing-32113');
